export default {
    ...
    "Suggest mode of index modal": "关键词搜索模式",
    "Keyword Order": "顺序搜索",
    "Fuzzy Suggest": "模糊搜索",
    "Set red dash line for nodes with ID ends with letter": "ID为字母结尾的节点设置红色虚线框",
    "In order to distinguish nodes which ID ends with letter and number": "用来区分ID为数字结尾和字母结尾的节点",
    "Fold node toggle": "节点折叠开关",
    "Open the fold icon(🟡🟢)": "打开折叠图标(🟡🟢)",
    "zk-local-graph-view": "局部关系视图",
    "Open close-relative graph": "打开近亲视图",

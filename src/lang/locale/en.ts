export default {
    ...
    "multiple IDs for main notes": "multiple IDs for main notes",
    "Specify a frontmatter field(array) for multiple IDs": "Specify a file property(array) for multiple IDs",
